export const errorMessages: Record<number, string> = {
  ...
  10105:
    'In cooldown for login, two identical login attempts should have a one-minute interval.',
  10106:
    'You are not yet an administrator and cannot access the management system.',
